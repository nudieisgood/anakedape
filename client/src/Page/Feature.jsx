      ...
      <div className="relative">
        ...
        <FadeIn delay={0.1} direction="left">
          <div className="hidden md:flex absolute right-6 bottom-6 tracking-wider flex-col gap-4">
            <p className="text-white text-2xl">FEATURE {feat.featureNo}</p>
            {feat?.featureTitle1 && (
      ...
      <div className="section-container px-6 my-16 md:my-36">
        <div className="md:hidden">
          ...
          {feat?.featureTitle1 && (
            <div className=" text-textMd">
              <span className=" inline-block">{feat?.featureTitle1}</span>
            </div>
          )}
          {feat?.featureTitle2 && (
            <div className=" text-textMd">
              <span className="inline-block">{feat?.featureTitle2}</span>
            </div>
          )}
        </div>
        ...
        <div className={`flex justify-end`}>
          {feat.photos.length > 1 && (
            <img src={feat?.photos[1]} className="object-cover" alt="" />
          )}
        </div>
        <div className="tracking-wider sm:tracking-widest text-lg my-24">
        ...
        <div className={`flex justify-start`}>
          {feat?.photos?.length > 2 && (
            <img src={feat?.photos[2]} className="object-cover" alt="" />
          )}
        </div>
        <div className="tracking-wider sm:tracking-widest text-lg my-24">
